...
let opts = JSON.parse(localStorage.getItem("doig_opts")) || defaultOpts;

const saveOpts = () => localStorage.setItem("doig_opts", JSON.stringify(opts));
const refreshOpts = () => {
...
const log = (msg) => DEBUG ? console.log("Doug Overlay - ", msg) : null
